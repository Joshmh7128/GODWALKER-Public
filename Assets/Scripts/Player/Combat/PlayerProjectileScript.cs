...
public class PlayerProjectileScript : MonoBehaviour
{
    ...
    void SetHomingTarget()
    {
        // slow down our speed
        speed = speed * 0.5f;
        if (arenaManager.activeArena.arenaMode == ArenaHandler.ArenaModes.Boss)
        {
            homingTarget = arenaManager.activeArena.bossEnemy.transform;
        }

        if (arenaManager.activeArena.arenaMode == ArenaHandler.ArenaModes.Wave)
        {
