...
public class ShielderFlyingEnemy : EnemyClassOld
{
    Vector3 newPos;
    ...
    private void Start()
    {
        ...
        foreach (Transform friendTransform in protectedEnemies)
        {
            if (friendTransform != null)
            {
                ...
                friendTransform.gameObject.GetComponent<EnemyClassOld>().invincible = true;
            }
        }
    }
        ...
        if (HP <= 0)
        {
            ...
            foreach (Transform friendTransform in protectedEnemies)
            {
                if (friendTransform != null)
                {
                    ...
                    friendTransform.gameObject.GetComponent<EnemyClassOld>().invincible = false;
                }
            }
