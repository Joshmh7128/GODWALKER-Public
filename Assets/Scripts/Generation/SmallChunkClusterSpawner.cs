...
public class SmallChunkClusterSpawner : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        {
            Instantiate(smallChunk, transform.position + new Vector3(Random.Range(-3, 3), 1, Random.Range(-3, 3)), Quaternion.Euler(Random.Range(0, 360), Random.Range(0, 360), Random.Range(0, 360)));
        }
    }
}
